...
module processor(
    ...
    //Player Scores
	 ...
	 // Players score updates
	 input [31:0] score_player1;
	 input [31:0] score_player2;
	 input [31:0] score_player3;
	 input [31:0] score_player4;
/***********************************************************************
												PC
*************************************************************************/
...
*************************************************************************/
	 ...
	 wire [31:0] extended_immediate, extended_immediate1;
	 sign_extend se_immediate(.out(extended_immediate1), 
									  .in(ir_fd_read[16:0]));
	// if it is an addi and the write reg is 1, 2, 3 or 4 use score value as an immediate
	 wire enable_immediate;
	 wire check_rd;
...
*************************************************************************/
	 ...
	 wire [1:0] dx_type;
	 wire [31:0] A_read, B_read, B, extended_N, pc_dx,ir_dx;
